...
while 1:
    ...
    if choose_a_number == "0":
        ...
        if course != "" and fee > 0 and name!= '':
            student_details.append(("Details:- {}".format(name),"Course:- {}".format(course),"Fee:- {}".format(fee))) #if users enters correct details a new list is created and append to empty list
        else:
