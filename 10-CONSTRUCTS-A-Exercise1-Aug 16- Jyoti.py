...
while 1:
    ...
    if first_number == '' and second_number == '':
        ...
        print("First number is greater than Second number")     #if first number is greater than second number prints first number is greater and breaks loop
        break
    elif int(second_number) > int(first_number):
        print("Second number is greater than First number")     #if second number is greater than first number prints second number is greater and breaks loop
        break
